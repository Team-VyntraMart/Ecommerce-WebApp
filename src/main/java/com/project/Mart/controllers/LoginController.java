...
import com.project.Mart.JWTConfiguration.AuthManager;
...
import com.project.Mart.controllers.RequestPojo.LoginRequest;
...
public class LoginController {
	...
	public ResponseEntity<?> userLogin(@RequestBody LoginRequest loginRequest) {
	 ...
	 private JSONObject getUserResponse(String token) {
	    	...
	    	try {
				UserModel user = userservice.getUserDetailById(_getUserId());
