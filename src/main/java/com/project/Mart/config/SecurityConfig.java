package com.project.Mart.config;
//for security config purpose
...
import com.project.Mart.JWTConfiguration.JwtAuthenticationEntryPoint;
import com.project.Mart.JWTConfiguration.JwtAuthenticationFilter;
import com.project.Mart.services.CustomUserDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/admin/**")
                	.hasRole("ADMIN")
                .antMatchers("/api/user/**","/api/payment/**")
                	.hasRole("USER");
                //.anyRequest()
                //.authenticated();
